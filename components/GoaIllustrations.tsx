...
export function GoaTextileRibbon() {
  return (
    <div className="w-full overflow-hidden bg-[#15361F] border-b-2 border-sunshine select-none">
      <svg
      ...
      >
        <pattern id="goa-textile-pattern" width="80" height="24" patternUnits="userSpaceOnUse">
          <polygon points="12,12 20,4 28,12 20,20" fill="#EA337F" />
          ...
          <path d="M0 12h8 M32 12h16 M72 12h8" stroke="#F9E24C" strokeWidth="1.5" />
          <circle cx="40" cy="8" r="1.5" fill="#F9E24C" />
          <circle cx="40" cy="16" r="1.5" fill="#F9E24C" />
          <polygon points="0,0 80,0 80,2 0,2" fill="#F9E24C" />
          <polygon points="0,22 80,22 80,24 0,24" fill="#F9E24C" />
        </pattern>
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "0 0 20px rgba(234, 51, 127, 0.7), 3px 4px 0px rgba(0,0,0,0.3)",
      }}
    >
...
export function PushPin({ color = "pink" }: { color?: "pink" | "yellow" | "green" }) {
  const bg = color === "pink" ? "#EA337F" : color === "yellow" ? "#F9E24C" : "#8FC93A";
  const border = color === "pink" ? "#C41F65" : color === "yellow" ? "#E5CE34" : "#2C663D";
  ...
  return (
    <svg viewBox="0 0 160 380" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <path
        ...
        strokeWidth="2"
      />
      <circle cx="66" cy="65" r="7" fill="#F9E24C" stroke="#15361F" strokeWidth="2" />
      <circle cx="76" cy="63" r="6" fill="#EA337F" stroke="#15361F" strokeWidth="2" />
    </svg>
  );
}
...
export function GoaRisingSun() {
  return (
    <svg viewBox="0 0 300 150" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-72 h-36">
      <line x1="150" y1="140" x2="150" y2="20" stroke="#F9E24C" strokeWidth="3" strokeLinecap="round" opacity="0.6" />
      <line x1="150" y1="140" x2="70" y2="40" stroke="#F9E24C" strokeWidth="3" strokeLinecap="round" opacity="0.6" />
      <line x1="150" y1="140" x2="230" y2="40" stroke="#F9E24C" strokeWidth="3" strokeLinecap="round" opacity="0.6" />
      <line x1="150" y1="140" x2="20" y2="90" stroke="#F9E24C" strokeWidth="3" strokeLinecap="round" opacity="0.6" />
      <line x1="150" y1="140" x2="280" y2="90" stroke="#F9E24C" strokeWidth="3" strokeLinecap="round" opacity="0.6" />
      <circle cx="150" cy="150" r="110" fill="#2C663D" opacity="0.5" />
      <circle cx="150" cy="150" r="85" fill="#F9E24C" />
      <circle cx="150" cy="150" r="65" fill="#EA337F" opacity="0.2" />
    </svg>
  );
}
  ...
  return (
    <div className="w-full relative overflow-hidden py-12 select-none">
      ...
      >
        ...
        <path d="M0 170 C400 150 800 185 1200 160 L1200 200 C600 220 300 180 0 200 Z" fill="#2C663D" opacity="0.4" />

        {/* Beach Shack */}
        <g transform="translate(480, 100)">
          <polygon points="30,0 210,0 240,40 0,40" fill="#8FC93A" stroke="#15361F" strokeWidth="3" />
          <polygon points="40,-8 200,-8 215,0 25,0" fill="#F9E24C" stroke="#15361F" strokeWidth="2" />
          <rect x="25" y="40" width="190" height="70" fill="#FEFBEA" stroke="#15361F" strokeWidth="3" />
          <line x1="45" y1="40" x2="45" y2="110" stroke="#15361F" strokeWidth="3" />
          <line x1="195" y1="40" x2="195" y2="110" stroke="#15361F" strokeWidth="3" />
          <line x1="120" y1="40" x2="120" y2="110" stroke="#15361F" strokeWidth="3" />
          <rect x="60" y="12" width="120" height="20" rx="4" fill="#EA337F" stroke="#FEFBEA" strokeWidth="2" />
        ...
        <g transform="translate(240, 130)">
          <path d="M10 50 A 45 45 0 0 1 90 50 Z" fill="#EA337F" stroke="#15361F" strokeWidth="2.5" />
          <path d="M35 50 A 45 45 0 0 1 65 50 Z" fill="#F9E24C" />
          <line x1="50" y1="50" x2="50" y2="90" stroke="#15361F" strokeWidth="3" />
        </g>

        <g transform="translate(860, 135)">
          <path d="M10 50 A 45 45 0 0 1 90 50 Z" fill="#F9E24C" stroke="#15361F" strokeWidth="2.5" />
          <path d="M35 50 A 45 45 0 0 1 65 50 Z" fill="#8FC93A" />
          <line x1="50" y1="50" x2="50" y2="85" stroke="#15361F" strokeWidth="3" />
        </g>

        {/* Surfboards */}
        <g transform="translate(180, 150) rotate(-15)">
          <path d="M0 0 C10 -25 15 -25 25 0 L22 70 C12 75 8 75 0 70 Z" fill="#EA337F" stroke="#15361F" strokeWidth="2" />
          <line x1="12" y1="-10" x2="12" y2="65" stroke="#F9E24C" strokeWidth="2" />
        </g>
        <g transform="translate(200, 155) rotate(10)">
          <path d="M0 0 C10 -25 15 -25 25 0 L22 70 C12 75 8 75 0 70 Z" fill="#F9E24C" stroke="#15361F" strokeWidth="2" />
